...
public class LocationService extends Service implements com.google.android.gms.location.LocationListener,
    ...
    public void onCreate() {
        super.onCreate();
        Loc_HARI_KI_PAURI.setLatitude(29.916069);
        Loc_HARI_KI_PAURI.setLongitude(78.102313);
    ...
    public void onLocationChanged(Location location) {
        ...
        } else if (location.distanceTo(Loc_GURUKUL_KANGRI) <= 100) {
            if (currentLocation != Loc_GURUKUL_KANGRI) {
                currentLocation = Loc_GURUKUL_KANGRI;
                position = 12;
        ...
        } else if (location.distanceTo(Loc_FET) <= 100) {
            if (currentLocation != Loc_FET) {
                currentLocation = Loc_FET;
                position = 13;
    ...
    public void sendNotification() {
        ...
        builder.setContentText("You are at " + str[position]);
        builder.setSmallIcon(R.drawable.ic_event_note_black_24dp);
        builder.setSubText("Click to know more about this place");
        builder.setContentTitle("NamoGange");
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        Toast.makeText(this, "Error Connecting Location Services", Toast.LENGTH_LONG).show();
    }
